...
describe 'User view own orders' do
  ...
  it 'and order items' do
    ...
    OrderItem.create!(product_model: product_a, order:, quantity: 13)
    OrderItem.create!(product_model: product_b, order:, quantity: 19)
    ...
    expect(page).to have_content '13 x Produto A'
    expect(page).to have_content '19 x Produto B'
  end
end
